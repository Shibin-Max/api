...
@DirtiesContext
class GEMMChannelStrategyTest {

    @Resource
    private GEMMChannelStrategy gEMMChannelStrategy;
    @Resource
    private GEMLChannelStrategy gEMLChannelStrategy;
    @Resource
    private GEMHChannelStrategy gemhChannelStrategy;
    @Resource
    private GEMMGChannelStrategy gEMMGChannelStrategy;
    @Resource
    private GEMUDChannelStrategy gEMUDChannelStrategy;

    private final PlatformEnum platform = PlatformEnum.GEML;
...
/*    @AfterEach
    ...
    void getInOrderSummary() {
        ...
        TInBetSummaryRecord inOrdersSummary = gEMMGChannelStrategy.getInOrdersSummary(param);
    }
    ...
    void getInOrders() {
        ...
        ZonedDateTime end = ZonedDateTime.of(LocalDateTime.of(2025, 6, 10, 0, 0, 0), ZoneId.of("Asia/Shanghai"));
        TimeRangeParam param = TimeRangeParam.from(start, end);
        InOrdersResult inOrders = gEMMGChannelStrategy.getInOrders(param);
    ...
    @Test
    void getOutOrders() {
        ZonedDateTime start = ZonedDateTime.of(LocalDateTime.of(2025, 6, 27, 0, 0, 0), ZoneId.of("Asia/Shanghai"));
        ZonedDateTime end = ZonedDateTime.of(LocalDateTime.of(2025, 6, 27, 3, 0, 0), ZoneId.of("Asia/Shanghai"));
        TimeRangeParam param = TimeRangeParam.from(start, end);
        LobbyOrderResult outOrders = gEMMChannelStrategy.getOutOrders(param);
        //汇总总投注额
    ...
    void getOutOrderSummary() {
        ...
        TimeRangeParam param = TimeRangeParam.from(start, end);
        TOutBetSummaryRecord outOrders = gEMLChannelStrategy.getOutOrdersSummary(param);
